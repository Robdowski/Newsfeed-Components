...
const data = [
  ...
  {
    title: "Do the Ninja Turtles Really Need a 5th Member?",
    date: "Sep 4th, 2019",
...
function createNews(data){
  ...
  button.addEventListener("click", e=> article.classList.toggle("article-open"))
